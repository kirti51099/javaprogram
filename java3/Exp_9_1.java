//Program using java modern tool
import javax.swing.*;
import java.awt.event.*;
public class Exp_9_1 extends JFrame implements ActionListener{
 JLabel l;
 ...
 String msg="";
 if(cb1.isSelected()){
int q=Integer.parseInt(JOptionPane.showInputDialog(this,"Enter Quantity forNotebook"));
 amount=amount+50*q;
...
JOptionPane.showMessageDialog(this,"SuccessfullyOrdered.","Alert",JOptionPane.WARNING_MESSAGE);
 }
 public static void main(String[] args) {
 Exp_9_1 E= new Exp_9_1();
 }
}